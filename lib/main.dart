            ...
            child: ListView(
              ...
              children: [
                UserAccountsDrawerHeader(
                  ...
                  accountEmail: const Text('faqihharun71@gmail.com',
                      style: TextStyle(color: Colors.white)),
                  ...
                  decoration: const BoxDecoration(
                      ...
                      image: DecorationImage(
                          fit: BoxFit.cover,
                          image: NetworkImage(
                              'https://i.pinimg.com/736x/78/1e/21/781e212cb0a891c6d8a3738c525e235d.jpg'))),
                ),
                ListTile(
                ...
                ListTile(
                  ...
                  onTap: () async {
                    final Uri url =
                        Uri.parse('https://www.instagram.com/alexhateppl/');
                ...
                ListTile(
                  ...
                  onTap: () async {
                    final Uri url =
                        Uri.parse('https://wa.me/6281288925210?text=Hello');
                    if (await canLaunchUrl(url)) {
                      await launchUrl(url,
                          mode: LaunchMode.externalApplication);
                    } else {
              ...
              children: [
                ...
                Padding(
                  ...
                  child: AnimatedTextKit(
                    animatedTexts: [
                      TyperAnimatedText(
                          "Flutter Developer that loves to learn new things. I'm currently working as a tech Developer at Kompas Gramedia.",
